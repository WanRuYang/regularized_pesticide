...
WITH t AS (
	...
	UNION 
	--SELECT *, 'Metam potassium' AS chem FROM pur.ai_nm WHERE dpr_nm ~ upper('methyldithiocarbamate')
	--UNION 
	...
	UNION
	--SELECT *, 'Iprodione' AS chem FROM pur.ai_nm WHERE dpr_nm ~ upper('Iprodione')
	--UNION
	SELECT *, 'OP' AS chem FROM pur.ai_nm WHERE dpr_nm ~ 'MALATHION'
	UNION
	--SELECT *, 'Mancozeb' AS chem FROM pur.ai_nm WHERE dpr_nm ~ upper('Mancozeb')
	--UNION
	--SELECT *, 'Maneb' AS chem FROM pur.ai_nm WHERE dpr_nm ~ upper('Maneb')
	--UNION
	SELECT *, 'OP' AS chem FROM pur.ai_nm WHERE dpr_nm ~ 'METHAMIDOPHOS'
	UNION
	SELECT *, 'OP' AS chem FROM pur.ai_nm WHERE dpr_nm ~ 'METHIDATHION'
	UNION
	SELECT *, 'OP' AS chem FROM pur.ai_nm WHERE dpr_nm ~ 'METHYL PARATHION'
	UNION
	--SELECT *, 'Methyl bromide' AS chem FROM pur.ai_nm WHERE dpr_nm ~ upper('Methyl bromide')
	--UNION
	--SELECT *, 'Molinate' AS chem FROM pur.ai_nm WHERE dpr_nm ~ upper('Molinate')
	--UNION
	--SELECT *, 'OP' AS chem FROM pur.ai_nm WHERE dpr_nm ~ upper('METHYL PARATHION')
	--UNION
	--SELECT *, 'Myclobutanil' AS chem FROM pur.ai_nm WHERE dpr_nm ~ upper('Myclobutanil')
	--UNION
	SELECT *, 'OP' AS chem FROM pur.ai_nm WHERE dpr_nm ~ upper('METHYL PARATHION')
	UNION
	SELECT *, 'OP' AS chem FROM pur.ai_nm WHERE dpr_nm ~ upper('NALED')
	UNION
	--SELECT *, 'Norflurazon' AS chem FROM pur.ai_nm WHERE dpr_nm ~ upper('Norflurazon')
	--UNION
	...
	UNION
	--SELECT *, 'Prometon' AS chem FROM pur.ai_nm WHERE dpr_nm ~ upper('Prometon')
	--UNION
	...
	UNION
	--SELECT *, 'Glyphoshpate' AS chem FROM pur.ai_nm WHERE dpr_nm ~ upper('glycine')
	--UNION 
	--SELECT *, 'Acetamiprid' AS chem FROM pur.ai_nm WHERE dpr_nm ~ upper('Acetamiprid')
	--UNION 
	--SELECT *, 'Imidacloprid' AS chem FROM pur.ai_nm WHERE dpr_nm ~ upper('Imidacloprid')
	--UNION 
